...
$( document ).ready(function() {
  $('.responsive-toggle-trigger').click(function(){
...
(function ($) {
  var $iframes = $(".main-content-spacer, .main-content-container").find("iframe");
...
(function() {
  ...
  var $scrim = $(".post-completion");
  var counter = $(".post-completion").data('counter');
  var id;
  var nextPage = $(".post-completion").data('page');
  var postCompletion = $(".post-actions-complete").data('post-completion-toggle');
  var hasautoAdvance = $(".post-completion").data("auto")
  window._wq = window._wq || [];
  _wq.push({ id: videoID, onReady: function(video) {

    video.bind("end", function() {
      $(".post-completion").fadeIn();
      var completionAudio = document.querySelector(".completion_audio")
      if(completionAudio){
        console.log("ssaudio")
      ...
      if (nextPage != null){
        $scrim.fadeIn("fast");
        if (postCompletion == true && hasautoAdvance == true){
          startCountdown()
        } else {
          $(".post-completion-box-cancel, .post-close-btn").on("click", function() {
            $scrim.fadeOut("fast");
          });
        }
      }
